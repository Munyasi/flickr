...
if ( !class_exists('afgFlickr') ) {
    ...
    class afgFlickr {
        ...
        *******************************/
        ...
        function photosets_getList ($user_id = NULL,$primary_photo_extras) {
            /* http://www.flickr.com/services/api/flickr.photosets.getList.html */
            $this->request("flickr.photosets.getList", array("user_id" => $user_id,"primary_photo_extras"=>$primary_photo_extras));
